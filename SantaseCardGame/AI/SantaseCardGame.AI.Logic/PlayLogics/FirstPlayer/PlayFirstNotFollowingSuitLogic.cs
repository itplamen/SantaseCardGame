namespace SantaseCardGame.AI.Logic.PlayLogics.FirstPlayer
{
    ...
    public class PlayFirstNotFollowingSuitLogic : BasePlayLogic
    {
        private readonly ITrickState trickState;
        private readonly IDeckState deckState;

        public PlayFirstNotFollowingSuitLogic(ITrickState trickState, IDeckState deckState, IEnumerable<IPlayerActionStrategy> strategies)
